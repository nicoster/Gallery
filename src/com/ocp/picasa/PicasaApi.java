...
public final class PicasaApi {
        ...
        for (int i = 0; i != numAccounts; ++i) {
            ...
            try {
                ...
                if (context instanceof Activity) {
                    Bundle bundle = accountManager.getAuthToken(account, PicasaService.SERVICE_NAME, null,
    ...
    /**
     * Returns a canonical username for a Gmail account. Lowercases the username
     * and strips off a "gmail.com" or "googlemail.com" domain, but leaves other
     * domains alone.
     * 
     * e.g., Passing in "User@gmail.com: will return "user".
     * 
     * @param username The username to be canonicalized.
     * @return The username, lowercased and possibly stripped of its domain if a
        ...
        try {
            synchronized (mOperation) {
                ...
                if (operation.outStatus == 200) {
                    ...
                    Log.e(Gallery.TAG, TAG + ": " + "deleteEntry: failed with status code " + operation.outStatus);
                }
            }
        } catch (IOException e) {
            Log.e(Gallery.TAG, TAG + ": " + "deleteEntry: " + e);
        }
        return RESULT_ERROR;
    }
