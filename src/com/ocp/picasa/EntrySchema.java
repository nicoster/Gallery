...
public final class EntrySchema {
    ...
    public void cursorToObject(Cursor cursor, Entry object) {
        try {
            ...
            Log.e(Gallery.TAG, TAG + ": " + "SchemaInfo.setFromCursor: object not of the right type");
        } catch (IllegalAccessException e) {
            Log.e(Gallery.TAG, TAG + ": " + "SchemaInfo.setFromCursor: field not accessible");
        }
    }
    ...
    public long insertOrReplace(SQLiteDatabase db, Entry entry) {
        ...
        if (entry.id == 0) {
            Log.i(Gallery.TAG, TAG + ": " + "removing id before insert");
            values.remove("_id");
        }
