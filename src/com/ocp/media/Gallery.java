...
import com.ocp.app.Res;
import com.ocp.cache.CacheService;
import com.ocp.cache.ImageList;
import com.ocp.wallpaper.RandomDataSource;
import com.ocp.wallpaper.Slideshow;
...
public final class Gallery extends Activity {
    public static final String REVIEW_ACTION = "com.ocp.media.action.REVIEW";

    public static final String TAG = "GALLERY_3D";
    ...
    private boolean forRestart = false;
    ...
    private static final float GRID_ITEM_HEIGHT = 100.8f;

    private static final float GRID_ITEM_WIDTH = 130.2f;
    ...
    private void initializeDataSource() {
        ...
        } else { // view intent for images and review intent for images and
                 // videos
            final Intent intent = getIntent();
    ...
    private void startupGallery() {
        ...
        mPicasaAccountThread = new HandlerThread("PicasaAccountMonitor");
